    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_McaAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_McaAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_McaAnswers__AuthUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "_AuthUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_McaAnswers__AuthUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "_AuthUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_McaAnswers_AnswerId",
                table: "McaAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_McaAnswers_CreatedById",
                table: "McaAnswers",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_McaAnswers_UpdatedById",
                table: "McaAnswers",
                column: "UpdatedById");
